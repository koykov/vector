...
Название библиотеки является метафорой - помимо указания на плоское хранилище нод, она активно использует векторные
расширения CPU для ускорения производительности (см. библиотеку https://github.com/koykov/simd). Она подключает
возможности AVX-512 при наличии поддержки в CPU, что даёт значительный прирост в скорости. При отсутствии AVX-512
расширений, используются младшие версии AVX расширений - AVX2/AVX или более старые до SSE2.
